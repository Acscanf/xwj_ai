  ...
  return (
    <div className="max-w-xs rounded-lg overflow-hidden bg-white transition-transform duration-300 hover:shadow-xl hover:scale-105 mx-auto">
      ...
      <div className="relative">
        ...
        />
        <span className='absolute top-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded'>
          New
        </span>
        <button className='absolute top-2 right-2 bg-gray-500 hover:text-red-500 transition-colors'>
      ...
      <div className='p-4'>
        <h3 className="text-lg font-semibold text-gray-800 line-clamp-1">
          Premium Wireless Headphones Premium Wireless Headphones Premium Wireless Headphones Premium Wireless Headphones Premium Wireless Headphones
        </h3>
